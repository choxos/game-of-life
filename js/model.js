...
(function (root) {
  ...
  const CATEGORIES = [
    { id: 'people', label: 'Friends and family', share: 25, units: [
      { id: 'dinner', one: 'two-hour dinner', many: 'two-hour dinners', h: 2 },
      { id: 'evening', one: 'long evening together', many: 'long evenings together', h: 5 },
    ] },
    { id: 'outside', label: 'Travel and the outdoors', share: 15, units: [
      { id: 'trip', one: 'week-long trip', many: 'week-long trips', h: 56, note: 'Counts 8 free hours a day for 7 days.' },
      { id: 'walk', one: 'two-hour walk', many: 'two-hour walks', h: 2 },
      { id: 'day', one: 'full day outdoors', many: 'full days outdoors', h: 8 },
    ] },
    { id: 'reading', label: 'Reading', share: 10, units: [
      { id: 'book', one: 'book', many: 'books', h: null },
    ] },
    { id: 'learning', label: 'Learning', share: 10, units: [
      { id: 'language', one: 'B2 language', many: 'B2 languages', h: 550, range: [500, 600],
        note: 'Cambridge English estimates about 500 to 600 guided hours from beginner to B2. A time equivalence, not a promise.' },
      { id: 'course', one: 'university course', many: 'university courses', h: 135,
        note: 'A 3-credit course: about 45 hours in class and 90 hours of study.' },
    ] },
    { id: 'exercise', label: 'Exercise', share: 10, units: [
      { id: 'workout', one: 'one-hour workout', many: 'one-hour workouts', h: 1 },
      { id: 'run', one: '5 km run', many: '5 km runs', h: 0.5 },
    ] },
    { id: 'screens', label: 'Movies, series and games', share: 15, units: [
      { id: 'movie', one: 'movie', many: 'movies', h: 2 },
      { id: 'season', one: 'TV season', many: 'TV seasons', h: 8, note: 'About 8 hours per season.' },
      { id: 'game', one: 'video game', many: 'video games', h: 25, note: 'About 25 hours to finish one.' },
    ] },
    { id: 'hobbies', label: 'Hobbies', share: 10, units: [
      { id: 'session', one: 'two-hour session', many: 'two-hour sessions', h: 2 },
      { id: 'project', one: 'weekend project', many: 'weekend projects', h: 12, note: 'About 12 hours each.' },
    ] },
    { id: 'nothing', label: 'Doing nothing', share: 5, units: [
      { id: 'afternoon', one: 'slow afternoon', many: 'slow afternoons', h: 4 },
      { id: 'nap', one: 'twenty-minute nap', many: 'twenty-minute naps', h: 1 / 3 },
    ] },
  ];
  ...
  function remainingYears(tables, country, sex, age) {
    const place = tables.places[country] || tables.places.WLD;
    return place[sex][clamp(Math.floor(age), 0, 100)];
  }
  ...
  function changes(inp, b) {
    ...
    out.push({ id: 'scroll', h: 0.75 * DAYS * b.years });
  ...
  const Model = {
    ...
    clamp, remainingYears, budget, apportion, yearRows, rebalance, unitHours, changes,
  };
